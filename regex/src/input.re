...
User-Agent\x3A\s+[^\r\n]*Indy\s+Library
User-Agent\x3A\s+_
Watcher\s+PC\s+IP\s+address\x3A
\&5=\d+\&6=\d+\&7=\d+\.\d+\&8=\d+
\.jsp
html\?[^\r\n]*PG=SPEEDBAR
...
\x2F(f|s)\?[^\r\n]*si=
((((\x2Fword|news)|weather)|joke)|tip\x2Easpx\?)
\x2FCD[^\r\n]*\x18\x16
...
(\x2Fnotifier\x2FconfigINTERNAL\.ini|update\.cgi\?)
(\x2Fproducts\x2Fspyblocs\x2Fspyblpat\d*\x2Edat\x2E\d+|spyblini\x2Eini)
\x2Fsearch?\x2Ephp3?\x3Fsearch\x3D
(\x2Ftba\x2Fcm|cu\?)
...
^From\x3A\s+\x22ProAgent\s+v\d+\x2E\d+\x22
^From\x3a[^\r\n]*EgySpy\s+Victim
^From\x3a[^\r\n]*Keylogger-Pro
^From\x3a[^\r\n]*NETObserve
^From\x3a[^\r\n]*SpyBuddy
...
^Host\x3A\s+www\x2Edigink\x2Ecom
...
^NiceSpy\x27s\s+email\s+assistant
^OVN.*Mini\s+Oblivion.*Ready
^Open\s+log\s+file\s+to\s+import
^Rabio\x3a[^\r\n]*RCSE
^Rabio\x3a[^\r\n]*search\x2Denhancer
...
^Subject\x3A\s+\x5B\d+\x5D\x2D\s+SpYOuTSiDe\s+transmission\s+with\s+log\s+\x2D
^Subject\x3a[^\r\n]*Activity[^\r\n]*Keylogger[^\r\n]*Logs
